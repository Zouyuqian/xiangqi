...
public class XiangqiApplication {
    ...
    private static void createAndShowGUI() {
        ...
        JButton surrenderButton = new JButton("认输");  // 新增认输按钮
        ...
        surrenderButton.setPreferredSize(new Dimension(100, 30));  // 设置认输按钮样式
        ...
        surrenderButton.addActionListener(e -> {
            ...
            int result = JOptionPane.showConfirmDialog(frame,
                    model.getCurrentPlayerColor() + "确定要认输吗？",
                    "认输",
                    JOptionPane.YES_NO_OPTION);
            if (result == JOptionPane.YES_OPTION) {
        ...
        controlPanel.add(surrenderButton);  // 添加认输按钮
